    ...
    return (
        <div className='bg-wallet_black min-w-full'>
            ...
            <div className='flex-1 flex-row text-white'>
                <h1 className='tracking-[6px] md:tracking-[12px]'>***</h1>
            ...
            <button className='absolute text-white bottom-8 right-2 p-2 ring-4 ring-wallet_green opacity-60 rounded-md hover:opacity-100'>How it works &#x2F2;</button>
            </div>
        </div>
    );
}
